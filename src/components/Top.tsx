  ...
  return (
    <>
      ...
      <div className="relative w-full">
        <div className="absolute top-12 z-30 ml-2 flex h-14 items-center rounded-sm bg-white pl-2 text-4xl font-bold text-black sm:ml-6 sm:h-24 sm:pl-4 sm:text-6xl md:text-7xl lg:top-12 lg:h-32 lg:text-8xl 2xl:top-[calc(100lvh-(5rem+25rem))] 2xl:ml-8">
        ...
        <div className="absolute top-[8rem] z-30 ml-2 flex h-14 items-center rounded-sm bg-white pl-2 text-4xl font-bold sm:top-[10.5rem] sm:ml-6 sm:h-24 sm:pl-4 sm:text-6xl md:text-7xl lg:top-52 lg:h-32 lg:text-8xl 2xl:top-[calc(100lvh-(5rem+15rem))] 2xl:ml-8">
          <span className="bg-gradient-to-r from-[#05C0FF] to-[#0070D9] bg-clip-text text-transparent">
